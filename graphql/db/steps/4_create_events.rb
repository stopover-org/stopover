...
events_data.each do |event_data|
    ...
    event.assign_attributes(
        **event_data.except(:firm_ref, :single_days_with_time),
        firm: firm,
        ...
        single_days_with_time: event_data[:single_days_with_time] ? [DateTime.parse(event_data[:single_days_with_time].to_s)] : []
    )
    event.save!
