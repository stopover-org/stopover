...
ActiveRecord::Schema[7.0].define(version: 20_230_514_172_438) do
  ...
  create_table 'account_interests', force: :cascade do |t|
    ...
    t.index %w[account_id interest_id], name: 'index_account_interests_on_account_id_and_interest_id', unique: true
  ...
  create_table 'stripe_integrations', force: :cascade do |t|
    ...
    t.string 'status'
    t.string 'price_type'
    t.index %w[stripeable_id stripeable_type], name: 'index_stripe_integrations_on_stripeable_id_and_stripeable_type'
  end
