  ...
  module FirmsRelated
    class InviteUser < BaseMutation
      ...
      def resolve(**args)
        ...
        user.account.account_firms.create!(firm: firm) if user.account.account_firms.where(firm: firm).empty?
      ...
      def authorized?(**inputs)
        ...
        return false, { errors: [I18n.t('graphql.errors.user_already_invited')] } if current_firm.removed?
