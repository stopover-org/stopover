...
module Types
  module EventRelated
    class EventType < Types::ModelObject
      field :achievements, [Types::EventRelated::AchievementType], null: false
      ...
      field :bookings, Types::BookingRelated::BookingType.connection_type, null: false, require_manager: true
      field :booking_cancellation_options, [Types::BookingRelated::BookingCancellationOptionType], null: false
      field :city, String
      field :country, String
      field :description, String, null: false
      field :duration_time, String, null: false
      field :event_options, [Types::EventRelated::EventOptionType], null: false
      field :event_type, Types::EventRelated::EventTypeEnum, null: false
      ...
      field :interests, [Types::EventRelated::InterestType], null: false
      field :landmarks, String
      field :latitude, Float
      field :longitude, Float
      field :max_attendees, Integer
      field :min_attendees, Integer
      field :my_bookings, [Types::BookingRelated::BookingType], null: false
      ...
      field :stripe_integrations, Types::EventRelated::StripeIntegrationType.connection_type, null: false, require_service_user: true
