...
role :app, %w{robot@staging.stopoverx.com}
role :web, %w{robot@staging.stopoverx.com}
role :db,  %w{robot@staging.stopoverx.com}
...
#   }
server 'robot@staging.stopoverx.com', roles: %w{web app}
