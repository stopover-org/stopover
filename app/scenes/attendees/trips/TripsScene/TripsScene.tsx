  ...
  return (
    <Grid>
      <Section color="primary" variant="soft">
        <Grid xs={12}>
          <Typography level="h3">
            {t("scenes.attendees.trips.tripsScene.draft")}
          </Typography>
        </Grid>
        <Grid xs={12}>
      ...
      <Section color="primary" variant="soft">
        <Grid xs={12}>
          <Typography level="h3">
            {t("scenes.attendees.trips.tripsScene.active")}
          </Typography>
        </Grid>
        <Grid xs={12}>
          <Stack>
      ...
      <Section color="primary" variant="soft">
        <Grid xs={12}>
          <Typography level="h3">
            {t("scenes.attendees.trips.tripsScene.future")}
          </Typography>
        </Grid>
        <Grid xs={12}>
          <Stack>
      ...
      <Section color="neutral" variant="soft">
        <Grid xs={12}>
          <Typography level="h3" color="neutral">
            {t("scenes.attendees.trips.tripsScene.past")}
          </Typography>
        </Grid>
        <Grid xs={12}>
          <Stack>
