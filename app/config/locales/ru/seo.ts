export default {
  seo: {
    ...
    events: {
      title:
        "События в {{city}}, с {{startDate}} по {{endDate}}. {{interests}}",
      description:
        "Планируйте ваше время в {{city}} на период с {{startDate}} по {{endDate}}. Изучите разнообразные мероприятия, включая {{interests}}, чтобы насладиться лучшими культурными и развлекательными событиями в {{city}}.",
      keywords: [
        "События в {{city}}",
        "{{city}} мероприятия",
        "{{startDate}} - {{endDate}}",
