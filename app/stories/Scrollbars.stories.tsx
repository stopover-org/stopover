...
const Preview = () => {
  const renderThumb = ({ style, ...props }: { style: CSSStyleRule }) => {
    const thumbStyle = {
  ...
  return (
    ...
    >
      <Typography>
        ...
        line in section 1.10.32. The standard chunk of Lorem Ipsum used since
        ...
        humour, or non-characteristic words etc. paragraphs words bytes lists
...
export const Default: ComponentStory<typeof Preview> = Preview.bind({});
